...
% YOUR CODE HERE
%
Fd = [] % Digital frequency axis from [0,0.5]
HF = [] % H(F) evaluated at all the frequencies in Fd
% Fill in these two variables above... They're just placeholders!

% Plot the frequency response
plot_freqz_response(HF, Fd, fsample, figure_num+1)


%% (Stem)Plot the Unit Sample Response 
